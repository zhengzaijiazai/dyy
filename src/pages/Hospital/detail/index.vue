<template>
    <div class="detail">
        <!-- 医院名字与医院等级的结构 -->
        <div class="top">
          <div class="name">{{DetailStore.hospitaiDetail.hospital?.hosname}}</div>
          <div class="level">
            <svg
              t="1685174493331"
              class="icon"
            ...
            <span>{{DetailStore.hospitaiDetail.hospital?.param.hostypeString}}</span>
          </div>
        </div>
        <!-- 医院的logo与路线 -->
        <div class="logo">
          ...
          <div class="right">
            <div class="address">
              ...
              <span>具体位置:{{DetailStore.hospitaiDetail.hospital?.param.fullAddress}}</span>
            </div>
            <div class="route">规划路线:{{DetailStore.hospitaiDetail.hospital?.route}}</div>
          </div>
        </div>
        <!-- 医院介绍 -->
        <div class="footer">
          <h1>医院介绍</h1>
          <p>
            {{DetailStore.hospitaiDetail.hospital?.intro}}
          </p>
        </div>
      </div>
</template>
